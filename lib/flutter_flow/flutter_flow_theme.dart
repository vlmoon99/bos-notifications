...
abstract class FlutterFlowTheme {
  ...
  late Color nEARBlue;
  late Color nEARLilac;
  late Color nEARPurple;
  late Color nEARAqua;
  late Color nEARGreen;
  late Color nEARGold;
  late Color nEAROrange;
  late Color nEARRed;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color nEARBlue = Color(0xFF5F8AFA);
  late Color nEARLilac = Color(0xFFA463B0);
  late Color nEARPurple = Color(0xFF6B6EF9);
  late Color nEARAqua = Color(0xFF4FD1D9);
  late Color nEARGreen = Color(0xFFAAD055);
  late Color nEARGold = Color(0xFFFFC860);
  late Color nEAROrange = Color(0xFFE3935B);
  late Color nEARRed = Color(0xFFDB5555);
}

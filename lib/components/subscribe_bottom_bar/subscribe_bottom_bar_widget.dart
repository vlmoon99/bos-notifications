                ...
                children: [
                  ...
                  Align(
                    ...
                    child: InkWell(
                      onTap: () {
                        FFAppState().update(() {
                          FFAppState().help.value = !FFAppState().help.value;
                        });
                      },
                      child: Padding(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        if (FFAppState().userfound.toString() ==
                                            '1')
                                          Icon(
                                            Icons.check,
                                            color: Color(0xFF65C3A2),
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: CachedNetworkImage(
                                              ...
                                              imageUrl: _model.textController
                                                          .text !=
                                                      ''
